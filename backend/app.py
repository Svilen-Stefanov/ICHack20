...
def get_dashboard():
    ...
    for user in all_users:
        ...
        profile = Profile(user.id, WEBEX_0, web_handle_0, user_name, user.profile_pic, user.institution, skills, user.date_of_birth, token_0)
...
def get_dashboard_with_topic(topic_id):
    ...
    # do ML magic
    best_mathes = skilled_users[:6]
    # TODO: jsonify
    return jsonify(best_mathes)
